        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="p-2 pb-5 xl:p-5 xl:pb-8 flex flex-col">
              <h1 className="font-bold md:text-lg lg:text-2xl xl:text-3xl   text-[#333333]">{product.name}</h1>
              <p className="text-xs sm:text-base md:text-lg lg:text-xl xl:text-2xl  text-[#666666]">{product.description}</p>
              <h1 className="font-bold md:text-lg lg:text-2xl xl:text-3xl  text-[#333333] mb-2 lg:mb-5 2xl:mb-10">${product.price}</h1>
